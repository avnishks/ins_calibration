...
{
     extern unsigned int sf_test1_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
                                                                                                       
     if(sf_test1_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;                         
     return 0;                                                                                           
}                                                                                                      
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] ) 
{
     extern unsigned int sf_test1_autoinheritance_info( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
     if(sf_test1_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;                         
     return 0;                                                                                           
}                                                                                                      
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
     extern unsigned int sf_test1_get_eml_resolved_functions_info( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
     char commandName[64];
     ...
     if(strcmp(machineName, "test1") == 0) {
         const mxArray *newRhs[2] = { NULL, NULL };
         newRhs[0] = prhs[0];
         newRhs[1] = prhs[2];
         return sf_test1_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
     }
...
extern unsigned int sf_test1_method_dispatcher(SimStruct *S,  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
...
{
     if(!strcmp(machineName,"test1")) {
         return(sf_test1_method_dispatcher(simstructPtr,chartFileNumber,specsCksum,method,data));
     }
     return 0;
}
extern void test1_terminator(void);
...
extern void test1_initializer(void);
extern void test1_register_exported_symbols(SimStruct* S);
extern void test1_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
    test1_register_exported_symbols(S);
}
