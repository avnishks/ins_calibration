...
static void initialize_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance);
static void initialize_params_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance);
static void enable_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance);
static void disable_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance);
...
static void finalize_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance);
...
static void c2_emlrt_marshallIn(SFc2_tablerot_idInstanceStruct *chartInstance, const mxArray *c2_y, const char_T *c2_name, real_T c2_b_y[3]);
static uint8_T c2_b_emlrt_marshallIn(SFc2_tablerot_idInstanceStruct *chartInstance, const mxArray *c2_b_is_active_c2_tablerot_id, const char_T *c2_name);
static void init_dsm_address_info(SFc2_tablerot_idInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c2_tablerot_id(SFc2_tablerot_idInstanceStruct *chartInstance)
{
_sfTime_ = (real_T)ssGetT(chartInstance->S);
chartInstance->c2_is_active_c2_tablerot_id = 0U;
}
...
chartInstance = (SFc2_tablerot_idInstanceStruct *)chartInstanceVoid;
c2_y = NULL;
...
const mxArray *sf_c2_tablerot_id_get_eml_resolved_functions_info(void)
{
...
static void c2_emlrt_marshallIn(SFc2_tablerot_idInstanceStruct *chartInstance, const mxArray *c2_y, const char_T *c2_name, real_T 
c2_b_y[3])
{
real_T c2_dv1[3];
int32_T c2_i11;
...
static uint8_T c2_b_emlrt_marshallIn(SFc2_tablerot_idInstanceStruct *chartInstance, const mxArray *c2_b_is_active_c2_tablerot_id, 
const char_T *c2_name)
{
uint8_T c2_y;
uint8_T c2_u0;
sf_mex_import(c2_name, sf_mex_dup(c2_b_is_active_c2_tablerot_id), &c2_u0, 1, 3, 0U, 0, 0U, 0);
c2_y = c2_u0;
sf_mex_destroy(&c2_b_is_active_c2_tablerot_id);
return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_tablerot_id_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_tablerot_id_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c2_tablerot_id(void)
{
   const char *infoFields[] = {"chartChecksum", "varInfo"};
   mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
   const char *infoEncStr[] = {
   "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_tablerot_id\",}}"
   };
   mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
   mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
   sf_c2_tablerot_id_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_tablerot_id(void *chartInstanceVar)
{
   chart_debug_initialization(((SFc2_tablerot_idInstanceStruct*) chartInstanceVar)->S,0);
   initialize_params_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*) chartInstanceVar);
   initialize_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_tablerot_id(void *chartInstanceVar)
{
   enable_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_tablerot_id(void *chartInstanceVar)
{
   disable_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*) chartInstanceVar);
}


static void sf_opaque_gateway_c2_tablerot_id(void *chartInstanceVar)
{
   sf_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_tablerot_id(SimStruct* S)
{
    ...
    prhs[2] = (mxArray*) get_sim_state_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*)chartInfo->chartInstance); /* raw sim ctx */
    prhs[3] = sf_get_sim_state_info_c2_tablerot_id(); /* state var info */
...
static void sf_internal_set_sim_state_c2_tablerot_id(SimStruct* S, const mxArray *st)
{
    ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
    mxArray *plhs[1] = {NULL};
    mxArray *prhs[4];
    ...
    prhs[3] = (mxArray*) sf_get_sim_state_info_c2_tablerot_id(); /* state var info */
    ...
    set_sim_state_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*)chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
    mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_tablerot_id(SimStruct* S)
{
    return sf_internal_get_sim_state_c2_tablerot_id(S);
}

static void sf_opaque_set_sim_state_c2_tablerot_id(SimStruct* S, const mxArray *st)
{
    sf_internal_set_sim_state_c2_tablerot_id(S, st);
}
...
static void mdlProcessParameters_c2_tablerot_id(SimStruct *S)
{
   int i;
   ...
   if(sf_machine_global_initializer_called()) {
       initialize_params_c2_tablerot_id((SFc2_tablerot_idInstanceStruct*)(((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
   }
}
...
static void mdlRTW_c2_tablerot_id(SimStruct *S)
{
   if(sim_mode_is_rtw_gen(S)) {
      sf_write_symbol_mapping(S, "tablerot_id", "tablerot_id",2);
...
void c2_tablerot_id_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
  case SS_CALL_MDL_START:
    mdlStart_c2_tablerot_id(S);
    break;
  case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_tablerot_id(S);
    break;
  case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_tablerot_id(S);
    break;
  default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_tablerot_id_method_dispatcher.\n"
